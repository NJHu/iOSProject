...
+ (void)UMPushStart:(NSDictionary *)launchOptions
{
    ...
    center.delegate = (LMJAppDelegate *)AppDelegateInstance;
...
+ (void)shareWebPageToPlatformType:(UMSocialPlatformType)platformType shareTitle:(NSString *)title subTitle:(NSString *)subTitle thumbImage:(NSString *)thumbImage shareURL:(NSString *)shareURL
{
    ...
    [[UMSocialManager defaultManager] shareToPlatform:platformType messageObject:messageObject currentViewController:nil completion:^(id data, NSError *error) {
        if (error) {
            ...
            // 分享成功的通知
            [kNotificationCenter postNotificationName:LMJUMSocialShareSucceedNotification object:shareURL];
        }
...
{
    [WJYAlertView showOneButtonWithTitle:error ? @"分享失败" : @"分享成功" Message:nil ButtonType:WJYAlertViewButtonTypeDefault ButtonTitle:@"确认" Click:^{
