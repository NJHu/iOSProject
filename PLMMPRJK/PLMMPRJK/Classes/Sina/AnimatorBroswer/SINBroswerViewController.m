...
- (void)viewDidLoad {
    ...
    LMJWeakSelf(self);
    [self.collectionView addTapActionWithBlock:^(UIGestureRecognizer *gestureRecoginzer) {
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.collectionView setPageX:self.startIndexPath.item];
}
...
- (CGRect)startRectWithBroswerAnimator:(SINBroswerAnimator *)broswerAnimator
{
    ...
    return [currentCell convertRect:currentCell.imageView.frame toView:kKeyWindow];
}
