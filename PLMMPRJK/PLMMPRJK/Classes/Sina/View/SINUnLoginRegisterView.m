...
- (void)setupUIOnce
{
    ...
    [self.coverImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.right.equalTo(self.caCycleImageView);
        make.top.equalTo(self.caCycleImageView).offset(-30);
        make.bottom.equalTo(self.caCycleImageView).offset(0);
    }];
    
    [self.slognImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.center.equalTo(self.caCycleImageView);
    ...
    [self.encourageLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.coverImageView).offset(-30);
        make.right.equalTo(self.coverImageView).offset(30);
    ...
    [btns mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.encourageLabel.mas_bottom).offset(20);
...
- (UIImageView *)caCycleImageView
{
    ...
    {
        UIImageView *caCycleImageView = [UIImageView imageViewWithImageNamed:@"visitordiscover_feed_image_smallicon"];
...
- (UIImageView *)coverImageView
{
    ...
    {
        UIImageView *coverImageView = [UIImageView imageViewWithImageNamed:@"visitordiscover_feed_mask_smallicon"];
...
- (UIImageView *)slognImageView
{
    ...
    {
        UIImageView *slognImageView = [UIImageView imageViewWithImageNamed:@"visitordiscover_feed_image_house"];
