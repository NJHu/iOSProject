...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
    ...
    if (textField.isEmptyAutoEnable && (LMJIsEmpty(textField.text.trimmingWhitespaceAndNewlines) || LMJIsEmpty(current))) {
...
- (NSString *)text {
    return ([[super text] trimmingWhitespaceAndNewlines]);
}
@end
