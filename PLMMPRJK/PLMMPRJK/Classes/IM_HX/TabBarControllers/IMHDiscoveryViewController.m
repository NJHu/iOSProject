...
@interface IMHDiscoveryViewController ()

@end

@implementation IMHDiscoveryViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"发现";
    
    LMJWordArrowItem *item = [LMJWordArrowItem itemWithTitle:@"朋友圈" subTitle: nil];
    
    item.image = [UIImage imageNamed:@"ff_IconShowAlbum"];
