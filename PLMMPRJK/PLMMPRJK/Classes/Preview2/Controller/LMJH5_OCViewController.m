...
#pragma mark - 添加红色的 View================================================
    ...
    if (contentSizeHeight != contentSize.height) {
        ...
        self.addRedView.frame = CGRectMake(0, contentSize.height - self.addRedView.lmj_height, Main_Screen_Width, self.addRedView.lmj_height);
    }
    //==========================================================================
...
#pragma mark - 添加红色的 View================================================
    ...
    NSString *js = [NSString stringWithFormat:@"\
                    ...
                    ", @(self.addRedView.lmj_height), @(Main_Screen_Width), @(self.addRedView.lmj_height)];
    [self.webView evaluateJavaScript:js completionHandler:^(id value, NSError *error) {
        ...
        self.addRedView.frame = CGRectMake(0, self.webView.scrollView.contentSize.height - self.addRedView.lmj_height, Main_Screen_Width, self.addRedView.lmj_height);
    }];
    //==========================================================================
...
- (void)webView:(WKWebView *)webView runJavaScriptAlertPanelWithMessage:(NSString *)message initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(void))completionHandler
{
    ...
    [WJYAlertView showOneButtonWithTitle:@"Alert" Message:message ButtonType:WJYAlertViewButtonTypeCancel ButtonTitle:@"confirm" Click:^{
...
- (void)webView:(WKWebView *)webView runJavaScriptConfirmPanelWithMessage:(NSString *)message initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(BOOL result))completionHandler
{
    ...
    [WJYAlertView showTwoButtonsWithTitle:@"Alert" Message: message ButtonType:WJYAlertViewButtonTypeCancel ButtonTitle:@"cancel" Click:^{
        
        completionHandler(NO);
        
    } ButtonType:WJYAlertViewButtonTypeDefault ButtonTitle:@"confirm" Click:^{
...
- (UIView *)addRedView
{
    if(_addRedView == nil)
    {
        UIView *addRedView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, Main_Screen_Width, 500)];
