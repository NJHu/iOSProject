...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context
{
    ...
    if ([keyPath isEqualToString:LMJKeyPath(self.imageItem, thumbnailImage)]) {
        
        self.picImageView.image = self.imageItem.thumbnailImage;
        
    }else if ([keyPath isEqualToString:LMJKeyPath(self.imageItem, uploadState)])
    {
        switch (self.imageItem.uploadState) {
            case MPImageUploadStateInit:
            {
                self.picImageView.hidden = NO;
                self.deleteButton.hidden = NO;
    ...
    }else if ([keyPath isEqualToString:LMJKeyPath(self.imageItem, uploadProgress)])
    {
        [self.progressView setProgress:self.imageItem.uploadProgress animated:YES];
