...
- (void)setupOnce
{
    ...
    [self.indicatorButton makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setGroup:(LMJGroup *)group
{
    ...
    //    [self.indicatorButton setImage:[UIImage imageNamed:group.isOpened ? @"arrow_down_icon" : @"arrow_up_icon"] forState:UIControlStateNormal];
