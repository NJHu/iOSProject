 ...
 */
@protocol IFlySpeechFaceRequestDelegate ;
...
/** 人脸识别请求类
 ...
 关于人脸识别的操作都在此类中。
 */
@interface IFlySpeechFaceRequest : NSObject

/** 设置委托对象 
 */
@property(nonatomic,assign) id<IFlySpeechFaceRequestDelegate> delegate ;

/** 返回识别对象的单例
 */
+ (IFlySpeechFaceRequest *) sharedInstance;
