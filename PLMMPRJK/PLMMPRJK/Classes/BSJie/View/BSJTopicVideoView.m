...
- (UILabel *)voiceLengthLabel
{
    if(_voiceLengthLabel == nil)
    {
        ...
        voiceLengthLabel.font = SYSTEMFONT(12);
        
        [voiceLengthLabel makeConstraints:^(MASConstraintMaker *make) {
...
- (UILabel *)voicePlayCountLabel
{
    if(_voicePlayCountLabel == nil)
    {
        ...
        voicePlayCountLabel.font = SYSTEMFONT(12);
        
        [voicePlayCountLabel makeConstraints:^(MASConstraintMaker *make) {
